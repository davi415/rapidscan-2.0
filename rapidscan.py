...
# Legends
proc_alta = bcolors.BADFAIL + "?" + bcolors.ENDC
proc_media  = bcolors.WARNING + "?" + bcolors.ENDC
...
# Tool Responses (Begins) [Responses + Severity (c - critica | h - alta | m - media | l - baixa | i - informação) + Reference for Vuln Definition and Remediation]
tool_resp   = [
